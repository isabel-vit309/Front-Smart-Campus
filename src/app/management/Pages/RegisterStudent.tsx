...
export default function RegisterStudent() {
  ...
  const handleRegister = async () => {
    ...
    setLoading(true);
    try {
      const { data: student } = await api.post("/api/students", {
        name,
        email,
        password,
        enrollment,
      ...
      if (selectedCourseId) {
        await api.post(`/api/students/${student.id}/enroll`, {
            ...
            <View style={styles.courseGrid}>
              {courses.map((c) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setSelectedCourseId(selectedCourseId === c.id ? "" : c.id)
                  }
                >
                  <Text
                    style={[
                      styles.courseChipText,
                      selectedCourseId === c.id && { color: "#FFFFFF" },
                    ]}
                  >
                    {c.name}
                  </Text>
