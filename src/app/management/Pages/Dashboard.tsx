import { Image, Text, View, StyleSheet, Pressable, ScrollView, ActivityIndicator } from "react-native";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    api.get("/api/access/recent?limit=5").then(({ data }) => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.welcomeContainer}>
          ...
          <Text style={styles.welcomeDescription}>
            Este é o seu portal de gestão. Acompanhe, organize e agilize sua rotina com mais eficiência.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.grid}>
            <Pressable style={styles.quickButton} onPress={() => navigation.navigate("RegisterStudent")}>
            ...
            <Pressable style={styles.quickButton} onPress={() => navigation.navigate("RegisterClass")}>
              <View style={styles.iconBox}>
            ...
            <Pressable style={styles.quickButton} onPress={() => navigation.navigate("ListStudents")}>
              <View style={styles.iconBox}>
            ...
            <Pressable style={styles.quickButton} onPress={() => navigation.navigate("ClassList")}>
              <View style={styles.iconBox}>
        ...
        <View style={[styles.card, { marginTop: 16 }]}>
          ...
          {loading ? (
            ...
            <Text style={{ color: "#C8D2E3", marginTop: 10, fontSize: 13 }}>Nenhum acesso registrado ainda.</Text>
          ) : (
            recentAccesses.map((entry) => {
              const time = new Date(entry.enteredAt).toLocaleTimeString("pt-BR", { hour: "2-digit", minute: "2-digit" });
              ...
              return (
                <View key={entry.id} style={styles.accessRow}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={styles.accessName}>{entry.student?.name ?? "—"}</Text>
                    <Text style={styles.accessDetail}>{course} · {room}</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  textContainer: { position: "absolute", top: 40, left: 20 },
  ...
  welcomeDescription: { color: "#C8D2E3", fontSize: 13, lineHeight: 18, marginTop: 6 },
  card: {
    backgroundColor: "#051e3e", width: "92%", marginTop: 30,
    borderRadius: 12, borderWidth: 1, padding: 14, borderColor: "#0B3D91",
  },
  titleCard: { color: "#80B3F8", fontWeight: "bold", fontSize: 16 },
  grid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginTop: 15, rowGap: 12 },
  quickButton: {
    backgroundColor: "#112e61", width: "48%", height: 100,
    borderRadius: 12, alignItems: "center", justifyContent: "center", paddingHorizontal: 6,
  },
  iconBox: {
    width: 42, height: 42, borderRadius: 8, backgroundColor: "#0B3D91",
    alignItems: "center", justifyContent: "center", marginBottom: 8,
  },
  quickText: { color: "#FFFFFF", fontSize: 11, textAlign: "center", fontWeight: "600" },
  accessRow: {
    flexDirection: "row", alignItems: "center", paddingVertical: 10,
    borderBottomWidth: 1, borderBottomColor: "#0B3D91", gap: 10,
  },
  accessIconBox: {
    width: 34, height: 34, borderRadius: 8, backgroundColor: "#112e61",
